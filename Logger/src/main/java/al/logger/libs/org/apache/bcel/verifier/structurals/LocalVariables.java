    ...
    private void merge(final LocalVariables lv, final int i) {
        try {
            ...
            if (locals[i] instanceof ReferenceType && lv.locals[i] instanceof ReferenceType) {
                ...
                /*
                 * TODO if ((locals[i] instanceof al.logger.libs.org.apache.bcel.generic.ReturnaddressType) && (lv.locals[i] instanceof
                 * al.logger.libs.org.apache.bcel.generic.ReturnaddressType)) { //System.err.println("merging "+locals[i]+" and "+lv.locals[i]); throw
