 ...
 */
package al.logger.libs.org.apache.bcel;

import java.io.IOException;

import al.logger.libs.org.apache.bcel.classfile.JavaClass;
import al.logger.libs.org.apache.bcel.util.ClassPath;
 ...
 *
 * @see al.logger.libs.org.apache.bcel.util.Repository
 * @see SyntheticRepository
 */
public abstract class Repository {

    private static al.logger.libs.org.apache.bcel.util.Repository repository = SyntheticRepository.getInstance();
     ...
     */
    public static al.logger.libs.org.apache.bcel.util.Repository getRepository() {
        return repository;
    }
     ...
     */
    public static void setRepository(final al.logger.libs.org.apache.bcel.util.Repository rep) {
        repository = rep;
    }
}
