...
import com.reflectmc.reflect.wrapper.wrappers.minecraft.render.DefaultVertexFormats;
import com.reflectmc.reflect.wrapper.wrappers.minecraft.render.GlStateManager;
import com.reflectmc.reflect.wrapper.wrappers.minecraft.render.Tessellator;
import com.reflectmc.reflect.wrapper.wrappers.minecraft.render.WorldRenderer;
...
*/
    ...
    public void cacheHeight(){
        Entry e = cacheString("1234567890ABC");
        height = 0;
        for (Glyph glyph : e.glyphs) {
            int h = glyph.texture.height / 2;
            if (h > height)
                height = h;
        }
    }
