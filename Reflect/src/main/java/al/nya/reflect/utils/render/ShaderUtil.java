    ...
    public ShaderUtil(String fragmentShaderLoc, String vertexShaderLoc) {
        ...
        switch (fragmentShaderLoc) {
            ...
            case "roundedRectGradient":
                ...
                break;
            default:
                fragmentShaderID = createShader(FileUtil.readByte(ResourceManager.getRes("shaders/" + fragmentShaderLoc)), GL_FRAGMENT_SHADER);
                break;
        }
        glAttachShader(program, fragmentShaderID);

        int vertexShaderID = createShader(FileUtil.readByte(ResourceManager.getRes("shaders/" + vertexShaderLoc)), GL_VERTEX_SHADER);
