...
public class EventPostRenderLiving implements Event {
    ...
    public EventPostRenderLiving(EntityLivingBase Entity, RendererLivingEntity Renderer, double X, double Y, double Z, float Yaw, float PartialTicks){
        entity = Entity;
        renderer = Renderer;
        x = X;
        y = Y;
