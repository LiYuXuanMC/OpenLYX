...
public class ShaderUtil {
        ...
        try {
            ...
            switch (fragmentShaderLoc) {
                ...
                case "roundedRectGradientRect":
                    ...
                    break;
                default:
                    fragmentShaderID = createShader(new ByteArrayInputStream(Logger.getInstance().resourceManager.getResourceBytes(fragmentShaderLoc)), GL_FRAGMENT_SHADER);
                    break;
            }
            glAttachShader(program, fragmentShaderID);

            int vertexShaderID = createShader(Logger.getInstance().resourceManager.getInputStream(vertexShaderLoc), GL_VERTEX_SHADER);
    ...
    public static void drawQuads() {
        //if (mc.getGameSettings().ofFastRender) return;
