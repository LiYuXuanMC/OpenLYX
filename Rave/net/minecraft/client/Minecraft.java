...
import cc.systemv.rave.event.events.EventLoop;
import cc.systemv.rave.event.events.EventTick;
...
{
    private static final int screenFrameRate = 120;
    ...
    public Animation guiAnimation = new Animation();
    ...
    public void run()
    {
        if (displayWidth < 1067) displayWidth = 1366;

        if (displayHeight < 622) displayHeight = 768;
        this.running = true;
    ...
    {
        Rave.getInstance().getEventBus().callEvent(new EventLoop());
    ...
    {
        return this.theWorld == null && this.currentScreen != null ? screenFrameRate : this.gameSettings.limitFramerate;
    }
    ...
    public void dispatchKeypresses()
    {
        ...
        if (!Keyboard.getEventKeyState()){
            Rave.getInstance().getEventBus().callEvent(new EventKey());
        }
