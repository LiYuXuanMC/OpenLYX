...
public class InvManager extends Module {
    ...
    public DoubleValue delayV = new DoubleValue("Delay", 500.0, 0.0, 1.0, 0.1);
    ...
    private float getDamage(ItemStack stack) {
        ...
        if (ItemTool.isItemTool(item)) {
            ItemTool sword = new ItemTool(item.getWrappedObject());
            damage += (float) sword.getMaxDamage();
        }

        if (ItemSword.isItemSword(item)) {
            ItemSword sword1 = new ItemSword(item.getWrappedObject());
    ...
    public boolean shouldDrop(ItemStack stack, int slot) {
        ...
        if (displayName.contains("(right click)")) {
            ...
            if (uhc.getValue()) {
                if (displayName.contains("ͷ")) {
                    return false;
                }
                if (displayName.contains("apple")) {
                    return false;
                }
                if (displayName.contains("head")) {
                    return false;
                }
                if (displayName.contains("gold")) {
                    return false;
                }
                if (displayName.contains("crafting table")) {
                    return false;
                }
                if (displayName.contains("stick")) {
                    return false;
                }
                if (displayName.contains("and") && displayName.contains("ril")) {
                    return false;
                }
                if (displayName.contains("axe of perun")) {
                    return false;
                }
                if (displayName.contains("barbarian")) {
                    return false;
                }
                if (displayName.contains("bloodlust")) {
                    return false;
                }
                if (displayName.contains("dragonchest")) {
                    return false;
                }
                if (displayName.contains("dragon sword")) {
                    return false;
                }
                if (displayName.contains("dragon armor")) {
                    return false;
                }
                if (displayName.contains("excalibur")) {
                    return false;
                }
                if (displayName.contains("exodus")) {
                    return false;
                }
                if (displayName.contains("fusion armor")) {
                    return false;
                }
                if (displayName.contains("hermes boots")) {
                    return false;
                }
                if (displayName.contains("hide of leviathan")) {
                    return false;
                }
                if (displayName.contains("scythe")) {
                    return false;
                }
                if (displayName.contains("seven-league boots")) {
                    return false;
                }
                if (displayName.contains("shoes of vidar")) {
                    return false;
                }
                if (displayName.contains("apprentice")) {
                    return false;
                }
                if (displayName.contains("master")) {
                    return false;
                }
                if (displayName.contains("vorpal")) {
                    return false;
                }
                if (displayName.contains("enchanted")) {
                    return false;
                }
                if (displayName.contains("spiked")) {
                    return false;
                }
                if (displayName.contains("tarnhelm")) {
                    return false;
                }
                if (displayName.contains("philosopher")) {
                    return false;
                }
                if (displayName.contains("anvil")) {
                    return false;
                }
                if (displayName.contains("panacea")) {
                    return false;
                }
                if (displayName.contains("fusion")) {
                    return false;
                }
                if (displayName.contains("excalibur")) {
                    return false;
                }
                if (displayName.contains("backpack")) {
                    return false;
                }
                if (displayName.contains("hermes")) {
                    return false;
                }
                if (displayName.contains("barbarian")) {
                    return false;
    ...
    float getToolEffect(ItemStack stack) {
        ...
        if (!(ItemTool.isItemTool(item))) {
            ...
            ItemTool tool = new ItemTool(item.getWrappedObject());
            float value = 1.0F;
            if (ItemPickaxe.isItemPickaxe(item)) {
    ...
    boolean isBadPotion(ItemStack stack) {
        if (!stack.isNull() && ItemPotion.isItemPotion(stack.getItem())) {
            ItemPotion potion = new ItemPotion(stack.getItem().getWrappedObject());
        ...
        for (int i = 9; i < 45; ++i) {
            ...
            if (inventoryContainer.getSlot(i).getHasStack()) {
                ...
                if (ItemArmor.isItemArmor(item)) {
                    ItemArmor armor = new ItemArmor(item.getWrappedObject());
