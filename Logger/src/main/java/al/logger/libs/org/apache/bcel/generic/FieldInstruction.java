...
public abstract class FieldInstruction extends FieldOrMethod {
    ...
    public String toString(final ConstantPool cp) {
        return al.logger.libs.org.apache.bcel.Const.getOpcodeName(super.getOpcode()) + " " + cp.constantToString(super.getIndex(), al.logger.libs.org.apache.bcel.Const.CONSTANT_Fieldref);
    }
}
