...
import cc.systemv.rave.utils.render.blur.BloomUtil;
import cc.systemv.rave.utils.render.blur.GaussianBlur;
import cc.systemv.rave.utils.render.blur.KawaseBlur;
...
public class RenderUtil extends InstanceAccess {
    ...
    public static void doStencil(float x, float y, float width, float height, float radius, Runnable content) {
        doStencil(x, y, width, height, radius, content, 2);
    }
    ...
    public static void upShadow(float x, float y, float width, float height, int radius, int offset) {
        ...
        BloomUtil.renderBlur(bloomFramebuffer.framebufferTexture, radius, offset);
    }
