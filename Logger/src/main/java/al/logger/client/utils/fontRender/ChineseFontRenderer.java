...
public class ChineseFontRenderer extends CFont {
    ...
    public ChineseFontRenderer(Font font, boolean antiAlias, boolean fractionalMetrics, double offsetX, double offsetY) {
    ...
    public ChineseFontRenderer(Font font, boolean antiAlias, boolean fractionalMetrics, boolean chinese, double offsetX,
                               double offsetY) {
    ...
    public ChineseFontRenderer(Font font, boolean antiAlias, boolean fractionalMetrics) {
        super(font, antiAlias, fractionalMetrics);
        this.offsetX = 0;
        this.offsetY = 0;
        setupMinecraftColorcodes();
    ...
    public void drawSplitString(String str, float x, float y, float wrapWidth, int color) {
        this.renderSplitString(str, x, y, wrapWidth, color);
    }

    private void renderSplitString(String str, float x, float y, float wrapWidth, int color) {
        for (String s : this.formatString(str, wrapWidth)) {
            this.renderStringAligned(s, x, y, wrapWidth, color);
            y += this.getStringHeight(s) + 4.0;
        }
    }

    private void renderStringAligned(String text, float x, float y, float width, int color) {
