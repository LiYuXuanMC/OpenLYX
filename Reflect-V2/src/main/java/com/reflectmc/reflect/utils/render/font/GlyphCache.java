...
import com.reflectmc.reflect.wrapper.wrappers.minecraft.render.GLAllocation;
...
public class GlyphCache
{
    ...
    void setDefaultFont(String name, int size, boolean antiAlias) {
        System.out.println("Reflect loading font \"" + name + "\"");
        usedFonts.clear();
    ...
    void setDefaultFont(Font font, int size, boolean antiAlias) {
        System.out.println("Reflect loading font \"" + font.getFontName() + "\"");
        usedFonts.clear();
        usedFonts.add(font);
