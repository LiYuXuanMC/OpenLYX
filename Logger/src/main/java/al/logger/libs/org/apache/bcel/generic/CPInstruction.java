...
public abstract class CPInstruction extends Instruction implements TypedInstruction, IndexedInstruction {
    ...
    public Type getType(final ConstantPoolGen cpg) {
        ...
        String name = cp.getConstantString(index, al.logger.libs.org.apache.bcel.Const.CONSTANT_Class);
        if (!name.startsWith("[")) {
            name = "L" + name + ";";
        }
    ...
    public String toString(final ConstantPool cp) {
        ...
        return al.logger.libs.org.apache.bcel.Const.getOpcodeName(super.getOpcode()) + " " + str;
    }
}
